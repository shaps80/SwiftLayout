...
//   */
//  public static func pin(edges: EdgeMask, of views: [View], to view: View, relation: NSLayoutRelation = .equal, margins: EdgeMargins = EdgeMargins(), priority: LayoutPriority = LayoutPriorityDefaultHigh) -> [NSLayoutConstraint] {
...
//   - returns: The applied constraints
//   */
//  public static func pin(edge: Edge, of views: [View], to otherEdge: Edge, of view: View, relation: NSLayoutRelation = .equal, margin: CGFloat = 0, priority: LayoutPriority = LayoutPriorityDefaultHigh) -> [NSLayoutConstraint] {
//    var constraints = [NSLayoutConstraint]()
//    views.forEach { constraints.append($0.pin(edge, toEdge: otherEdge, toView: view, relation: relation, margin: margin, priority: priority)) }
//    return constraints
//  }
//  
//  /**
...
//   - returns: The applied constraints
//   */
//  public static func align(axis: Axis, of views: [View], to view: View, offset: CGFloat = 0, priority: LayoutPriority = LayoutPriorityDefaultHigh) -> [NSLayoutConstraint] {
//    var constraints = [NSLayoutConstraint]()
...
//   - returns: The applied constraints
//   */
//  public static func size(axis: Axis, of views: [View], relation: NSLayoutRelation, size: CGFloat, priority: LayoutPriority = LayoutPriorityDefaultHigh) -> [NSLayoutConstraint] {
//    var constraints = [NSLayoutConstraint]()
...
//   */
//  public static func size(axis: Axis, of views: [View], relativeTo otherAxis: Axis, ofView view: View, ratio: CGFloat = 1, priority: LayoutPriority = LayoutPriorityDefaultHigh) -> [NSLayoutConstraint] {
//    var constraints = [NSLayoutConstraint]()
